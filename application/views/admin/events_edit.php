...
<div class="form-card">
    <?= form_open_multipart('admin/events_edit/' . $event['id'], ['id' => 'eventForm']) ?>
        <div class="form-grid">
            ...
            <div class="form-group">
                ...
                <input type="datetime-local" id="item_collection_deadline" name="item_collection_deadline" class="form-control" value="<?= set_value('item_collection_deadline', !empty($event['item_collection_deadline']) ? date('Y-m-d\TH:i', strtotime($event['item_collection_deadline'])) : '') ?>" required>
                <span class="form-error-msg"></span>
            ...
            <div class="form-group">
                ...
                <input type="datetime-local" id="auction_start" name="auction_start" class="form-control" value="<?= set_value('auction_start', !empty($event['auction_start']) ? date('Y-m-d\TH:i', strtotime($event['auction_start'])) : '') ?>" required>
                <span class="form-error-msg"></span>
            ...
            <div class="form-group">
                ...
                <input type="datetime-local" id="auction_end" name="auction_end" class="form-control" value="<?= set_value('auction_end', !empty($event['auction_end']) ? date('Y-m-d\TH:i', strtotime($event['auction_end'])) : '') ?>" required>
                <span class="form-error-msg"></span>
            ...
            <div class="form-group">
                ...
                <select id="status" name="status" class="form-control" required>
                    ...
                    foreach ($statuses as $val => $label):
                        $selected = set_value('status', $event['status']) === $val ? 'selected' : '';
                    ?>
